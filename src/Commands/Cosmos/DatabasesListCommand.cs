...
public class DatabasesListCommand : BaseCosmosCommand<DatabasesListArguments>
{
    public DatabasesListCommand() : base()
    {
    ...
    protected override DatabasesListArguments BindArguments(ParseResult parseResult)
    {
