...
namespace AzureMcp.Commands.TerraformBestPractices;
...
public sealed class TerraformBestPracticesGetCommand(ILogger<TerraformBestPracticesGetCommand> logger) : BaseCommand()
{
    ...
    private readonly ILogger<TerraformBestPracticesGetCommand> _logger;
    ...
    {
        var assembly = typeof(TerraformBestPracticesGetCommand).Assembly;
        const string ResourceName = "AzureMcp.Resources.terraform-best-practices.txt";
